            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('profile.update', $user->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3 d-flex align-items-center justify-content-center">
                            <ul class="list-group col-8 p-0">
                                <li class="list-group-item" data-bs-toggle="collapse" href="#collapseHobbies"
                                    role="button" aria-expanded="false" aria-controls="collapseHobbies">
                                    Choisi tes hobbies
                                </li>
                        ...
                        <div class="row mb-3">
                            <div class="col-6">
                                <label for="picture">Ma photo</label>
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inactive" name="inactive" value="0" {{ !$user->active ? 'checked' : '' }}>
